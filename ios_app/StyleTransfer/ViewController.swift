...
class ViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
  ...
  private var inputImage = UIImage(named: "p1080")!
...
//        la_muse(configuration: cpuConfig).model,
        sr1080(configuration: gpuConfig).model
      ] * 4
      return models
    } catch {
  ...
  private func stylizeImage(cgImage: CGImage, model: MLModel) -> CGImage {
    ...
    let input = StyleTransferInput(input: pixelBuffer(cgImage: cgImage, width: 1080, height: 1920))
